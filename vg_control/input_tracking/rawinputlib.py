...
class RawInputReader:
    def __init__(self, rawinput_lib):
        self.rawinput_lib = rawinput_lib
        self.inputs = [MouseMoveInputReader(rawinput_lib), MouseButtonInputReader(rawinput_lib), MouseScrollInputReader(rawinput_lib), KeyboardInputReader(rawinput_lib)]
